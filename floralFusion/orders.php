...
<section class="placed-orders">
    ...
    <div class="box">
        ...
        <p> total price : <span>PKR <?php echo $fetch_orders['total_price']; ?>/-</span> </p>
        <p> delivery charges : <span>PKR <?php echo 200; ?>/-</span> </p>
        <p> grand total : <span>PKR <?php echo $fetch_orders['total_price'] + 200; ?>/-</span> </p>
